---
name: boy-scout
description: Use when fixing, editing, changing, debugging, or working with code in any programming language. Applies the Boy Scout Rule—always leave code cleaner than you found it. Orchestrates other clean code skills as needed.
when_to_use: |
...
| Task | Trigger Skill |
|------|---------------|
| Writing/reviewing any code | `clean-general` (master) |
...
When reviewing code:
1. Load `clean-general` or language-specific clean code instructions for comprehensive rule checking
