...
| US70 — Là một kỹ sư AI/hệ thống, tôi muốn xem biểu đồ dòng thực thi thể hiện dữ liệu đầu vào, các công cụ đã gọi, kết quả trả về và việc bàn giao nhiệm vụ giữa các Agent để truy vết nguyên nhân gốc rễ khi xảy ra lỗi hoặc phản hồi chậm trễ. | SYS70 — Là hệ thống kiểm toán, tôi cần tự động bắt và lưu trữ đầy đủ dữ liệu đầu vào, phản hồi, nguồn dữ liệu, công cụ đã gọi, kết quả công cụ, tóm tắt lý do quyết định, mã lỗi và phiên bản Agent để hỗ trợ truy vết và kiểm tra lại quyết định. |
